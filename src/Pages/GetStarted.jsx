...
const GetStarted = () => {
  ...
  return (
    <div className="get-started-container flex flex-col justify-center items-center text-center mt-32 px-4">
      <div className='p-5 rounded-md shadow shadow-cyan-500'>
        {/* Main title */}
